...
int main()
{
	...
	////Variaveis que serÃ£o calculadas
	...
	int i; // variavel i responsavel por ver a linha
	i=l_; // definindo a variavel i
	cout << "Linha " << 0 << " estacao " << n-1 << endl; // demonstrando o caso inicial
	for(int j = n-1;j>0;j--){ // realização da recuperação do caminho
		i = l[i][j]; // definindo a linha que foi usada
		cout << "Linha " << i << " estacao " << j-1 << endl; // demonstrando a recuperação do caminho
	}
	// Caminho contrario 
