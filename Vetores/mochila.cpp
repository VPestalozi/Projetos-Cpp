...
int main()
{
	...
	// ENTRADA:
	cin >> capacidade; //Quantidade de brinquedos no parque
	cin >> n; // tempo em cada brinquedo

	//Tempo e nota de cada brinquedo
	for(int i=0; i<n; i++)
	...
	int i,j;
	int soma=0; // Atribuindo a soma das notas
	i = 0; // do item 0->final
	...
	cout << soma << endl; // Demonstrando a soma 
